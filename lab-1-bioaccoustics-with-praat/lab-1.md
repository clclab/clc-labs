...
Phonemes are the basic components of speech. The word "slit", for example consists of a fricative, a liquid, a vowel, and a plosive or stop (both so called "consonants").
Plosives are generated by completely stopping the airflow for a fraction of a section, resulting in complete silence.
