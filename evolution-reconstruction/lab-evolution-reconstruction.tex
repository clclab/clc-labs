...
\maketitle
\blfootnote{\emph{Last updated on \today{}}}
...
If you don't manage to finish those sections, you can work on them at home, and ask questions by e-mail or during the next lab.

% TODO kort uitleggen verschil bestand en console in R Studio
...
You need these two R files in the \file{lab-evolution-reconstruction} folder: \file{auxiliary\_functions.R} and \file{simulated\_evolution.R}.\\

\begin{exercise}
    \action Start RStudio and set the \emph{working directory} to your locally saved \file{lab-evolution-reconstruction} folder.
    \action Open the provided \file{answers-evo-reconstr-1.R} file in the \emph{Script editor} (click \emph{File > Open File...} in RStudio). This will be the script to add your code to in this section of the lab. 
